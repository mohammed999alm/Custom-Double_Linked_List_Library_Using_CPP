...
public:
	...
	{
		//There's no need the condition of head == NULL cause if the node you got  via the parameter is NULL when the list is empty
		if (node == NULL)
		{
			return;
		}
